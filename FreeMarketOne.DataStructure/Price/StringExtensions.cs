...
namespace FreeMarketOne.DataStructure.Price
{
    ...
    {
        /// <summary>
        ///Returns lower cased hex string from byte array.
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        public static string ToLowerHex(this byte[] data)
        {
            return ToLowerHex(data, "");
        }

        /// <summary>
        /// Returns upper cased hex string from byte array.
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        public static string ToLowerHex(this byte[] data, string prefix)
        {
