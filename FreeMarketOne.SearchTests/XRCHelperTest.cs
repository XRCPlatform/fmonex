...
namespace FreeMarketOne.SearchTests
{
    ...
    public class XRCHelperTest
    {
        ...
        public void TransactionSummaryIsReturned()
        {
            ...
            BlockchainTransactionGetResponse blockchainTransaction = BlockchainTransactionGetResponse.FromJson(model);
            IElectrumClient client = Substitute.For<IElectrumClient>();
            client.GetBlockchainTransactionGet(txHash, true).Returns(blockchainTransaction);
            ...
            Assert.AreEqual(summary.Total, 1050000d);
        ...
        public void TransactionTotalIsCaluculated()
        {
            ...
            Assert.AreEqual(summary.Confirmations, 12171);
            Assert.AreEqual(summary.Total, 2100000d);
            Assert.AreEqual(summary.Date.UtcDateTime, DateTime.Parse("Saturday, 20 October 2018 20:16:18"));
